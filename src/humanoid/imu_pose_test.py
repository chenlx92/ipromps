...
# test_set = np.hstack((test_set_spanner_handover_imu_norm, np.zeros([len_normal, 7])))
...
# aluminum hold
test_set = np.hstack((train_set_aluminum_hold_imu_norm20, np.zeros([len_normal, 7])))
...
# spanner handover
test_set = np.hstack((train_set_spanner_handover_imu_norm20, np.zeros([len_normal, 7])))
...
# # tape hold
# test_set = np.hstack((train_set_tape_hold_imu_norm20, np.zeros([len_normal, 7])))
...
# test_set = np.hstack((train_set_tape_hold_imu_norm23, np.zeros([len_normal, 7])))
# test_set = np.hstack((train_set_tape_hold_imu_norm24, np.zeros([len_normal, 7])))
# test_set = np.hstack((train_set_tape_hold_imu_norm25, np.zeros([len_normal, 7])))
# test_set = np.hstack((train_set_tape_hold_imu_norm26, np.zeros([len_normal, 7])))
# test_set = np.hstack((train_set_tape_hold_imu_norm27, np.zeros([len_normal, 7])))
# test_set = np.hstack((train_set_tape_hold_imu_norm28, np.zeros([len_normal, 7])))
# test_set = np.hstack((train_set_tape_hold_imu_norm29, np.zeros([len_normal, 7])))
