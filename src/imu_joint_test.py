...
ipromp_aluminum_hold = iprompslib_imu_joint.IProMP(num_joints=11, nrBasis=11, sigma=0.05, num_samples=101)
ipromp_spanner_handover = iprompslib_imu_joint.IProMP(num_joints=11, nrBasis=11, sigma=0.05, num_samples=101)
ipromp_tape_hold = iprompslib_imu_joint.IProMP(num_joints=11, nrBasis=11, sigma=0.05, num_samples=101)
