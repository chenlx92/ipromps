...
ndpromp = ipromps.NDProMP(num_joints=15, nrBasis=11, sigma=0.05, num_samples=101)
...
for i in range(8):
    plt.subplot(421+i)
    plt.plot(ndpromp.x, test_set_emg_norm_filtered[:,i], color='r', linewidth=3)
    ndpromp.promps[i].plot_updated(ndpromp.x, color='r')
plt.figure(5)
for i in range(7):
    plt.subplot(711+i)
    plt.plot(ndpromp.x, test_set_joint_norm_filtered[:,i], color='r', linewidth=3)
...
#    ndpromp.promps[8+i].plot_updated(ndpromp.x, color='r')
## add via point as observation
#ndpromp.add_viapoint(0.08, test_set_norm_filtered[0.08*100,:], 0.0001)
#ndpromp.add_viapoint(0.18, test_set_norm_filtered[0.18*100,:], 0.0001)
#ndpromp.add_viapoint(0.28, test_set_norm_filtered[0.28*100,:], 0.0001)
#
#plt.figure(24)
#for i in range(8):
#    plt.subplot(421+i)
#    plt.plot(ndpromp.x, test_set_emg_norm_filtered[:,i], color='g')
#    ndpromp.promps[i].plot_updated(ndpromp.x, color='g')
#plt.figure(25)
#for i in range(7):
#    plt.subplot(711+i)
#    plt.plot(ndpromp.x, test_set_joint_norm_filtered[:,i], color='g')
#    ndpromp.promps[8+i].plot_updated(ndpromp.x, color='g')
