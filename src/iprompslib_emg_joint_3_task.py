#!/usr/bin/python
# Filename: iprompslib_emg_joint_3_task_test.py
...
class NDProMP(object):
    ...
    def add_demonstration(self, demonstration):
        ...
        self.demo_W_full = np.hstack([self.promps[0].W, self.promps[1].W, self.promps[2].W, self.promps[3].W,
                                      ...
                                      self.promps[8].W, self.promps[9].W, self.promps[10].W, self.promps[11].W,
                                      self.promps[12].W, self.promps[13].W, self.promps[14].W])
