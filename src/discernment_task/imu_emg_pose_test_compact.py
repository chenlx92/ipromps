...
if b_plot_prior_distribution == True:
    ...
    for i in range(8):
        plt.subplot(421+i)
        ipromp_aluminum_hold.promps[4+i].plot(color='y', legend='alumnium hold model, emg');plt.axis('off')
    pl.savefig('./fig/aluminum_hold_emg_prior.eps', format='eps'); pl.savefig('./fig/aluminum_hold_emg_prior.pdf', format='pdf')
    plt.figure(52)
    for i in range(7):
        plt.subplot(711+i)
        ipromp_aluminum_hold.promps[4+8+i].plot(color='r', legend='alumnium hold model, pose');plt.axis('off')
    ...
    for i in range(8):
        plt.subplot(421+i)
        ipromp_spanner_handover.promps[4+i].plot(color='y', legend='spanner handover model, emg');plt.axis('off')
    pl.savefig('./fig/spanner_handover_emg_prior.eps', format='eps'); pl.savefig('./fig/spanner_handover_emg_prior.pdf', format='pdf')
    plt.figure(62)
    for i in range(7):
        plt.subplot(711+i)
        ipromp_spanner_handover.promps[4+8+i].plot(color='r', legend='spanner handover model, pose');plt.axis('off')
    ...
    for i in range(8):
        plt.subplot(421+i)
        ipromp_tape_hold.promps[4+i].plot(color='y', legend='tape hold model, emg');plt.axis('off')
